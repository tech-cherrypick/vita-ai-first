...
interface PatientLoginPageProps {
    onSignIn: (details: { name: string; email: string; phone: string; uid: string }) => void;
    onBack: () => void;
}
...
const PatientLoginPage: React.FC<PatientLoginPageProps> = ({ onSignIn, onBack }) => {
    ...
    const [googleUser, setGoogleUser] = useState<{ name: string; email: string; uid: string } | null>(null);
