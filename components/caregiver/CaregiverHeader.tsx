...
const CareCoordinatorHeader: React.FC<CareCoordinatorHeaderProps> = ({ onSignOut, currentView, setView }) => {
                ...
                <div className="flex items-center justify-between h-20">
                    ...
                    <div className="flex items-center gap-2 sm:gap-4">
                        <div className="text-right hidden sm:block">
                             <p className="text-sm font-semibold text-gray-800">Alex Ray</p>
