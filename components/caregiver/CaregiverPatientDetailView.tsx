...
const CareCoordinatorPatientDetailView: React.FC<CareCoordinatorPatientDetailViewProps> = ({ patient, tasks, onBack, onUpdatePatient, onCompleteTask, onSendMessage }) => {
    return (
        <div className="animate-fade-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <ConsultationTimeline timeline={patient.timeline} />
